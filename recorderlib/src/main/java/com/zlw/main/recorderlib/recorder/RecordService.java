...
public class RecordService extends Service {
    ...
    public static void changeRecordName(String recordName) {
        currentConfig.setRecordName(recordName);
    }
    ...
    private static String getFilePath() {
        ...
        return String.format(Locale.getDefault(), "%s%s%s", fileDir, currentConfig.getRecordName(), currentConfig.getFormat().getExtension());
    }
